...
<head>
    ...
    <title>Liste des lieus - Jeux Olympiques - Los Angeles 2028</title>
</head>
...
<body>
    ...
    <main>
        ...
        <form action="add-places.php" method="post" onsubmit="">
    ...
    <script>
        ...
        function deletelieuConfirmation(id_lieu) {
            if (confirm("Êtes-vous sûr de vouloir supprimer un lieu?")) {
