...
<body>
    ...
    <main>
        ...
        <form action="add-sports.php" method="post" onsubmit="">
            <input type="submit" value="Ajouter un sport">
        </form>
    ...
    <script>
        function openAddSportForm() {
            window.location.href = 'add-sports.php';
        }

        function openModifySportForm(id_sport) {
            window.location.href = 'modify-sports.php?id_sport=' + id_sport;
        }

        function deleteSportConfirmation(id_sport) {
            if (confirm("Êtes-vous sûr de vouloir supprimer ce sport?")) {
                window.location.href = 'delete-sports.php?id_sport=' + id_sport;
            }
        }
    </script>
</body>
