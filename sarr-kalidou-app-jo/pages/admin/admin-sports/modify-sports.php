...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nomSport)) {
        ...
        header("Location: modify-sports.php?id_sport=$id_sport");
        exit();
    }
...
<body>
    ...
    <main>
        ...
        <form action="modify-sports.php?id_sport=<?php echo $id_sport; ?>" method="post" onsubmit="return confirm('Êtes-vous sûr de vouloir modifier ce sport?')">
            <label for="nomSport">Nom du Sport :</label>
            <input type="text" name="nomSport" id="nomSport" value="<?php echo htmlspecialchars($sport['nom_sport']); ?>" required>
