...
// Vérifiez si l'ID d'utilisateur est fourni dans l'URL
if (!isset($_GET['id_utilisateur'])) {
    ...
    // Vérifiez si l'ID d'utilisateur est un entier valide
    if ($id_utilisateur === false) {
        ...
        try {
            ...
            $_SESSION['error'] = "Erreur lors de la suppression d'utilisateur : " . htmlspecialchars($e->getMessage(), ENT_QUOTES, 'UTF-8');
            header('Location: manage-users.php');
            exit();
        }
    }
