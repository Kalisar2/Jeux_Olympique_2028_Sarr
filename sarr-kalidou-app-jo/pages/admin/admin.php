...
$nom_utilisateur = isset($_SESSION['Kalidou']) ? $_SESSION['Kalidou'] : '';
$prenom_utilisateur = isset($_SESSION['Sarr']) ? $_SESSION['Sarr'] : '';
...
<body>
    <header>
        <nav>
            ...
            <ul class="menu">
                <li><a href="./admin-users/manage-users.php">Accueil Administration</a></li>
    ...
    <main>
        <p class="info-login">
            Bonjour SuperAdmin, <?php echo htmlspecialchars($nom_utilisateur . " " . $prenom_utilisateur); ?>
        </p>
